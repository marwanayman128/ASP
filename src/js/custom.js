...
$(function() {
    ...
    $(".news .owl-carousel").owlCarousel({
        ...
        nav: false,
        navText: [
            "<span class='lnr asp-small-left'></span>",
            "<span class='lnr asp-small-right'></span>",
        ],
        responsiveClass: true,
        responsive: {
            0: {
...
$(document).ready(function() {
    ...
    $(".slider .owl-carousel").owlCarousel({
        ...
        nav: false,
        navText: [
            '<i class="asp-small-left" aria-hidden="true"></i>',
            '<i class="asp-small-right" aria-hidden="true"></i>',
        ],
        responsiveClass: true,
        responsive: {
            0: {
