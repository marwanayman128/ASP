                    ...
                    <div className="row">
                        <div className="col-md-6 mb-30">
                            ...
                            <ul className="listext list-unstyled mb-30">
                                <li>
                                    <div className="listext-icon"> <i className="asp-d-check" /> </div>
                        ...
                        <div className="col-md-6">
                            <div className="about-img"> <img src="https://www.aspbuilding.com.au/data/uploads/images/about/about1.jpg" alt />
